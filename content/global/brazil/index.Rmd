...
blogdown::shortcode(
  "bootstrap-card-alt",
  img="x-cover-bra-eur-2025.png",
  link="bra-eur-2025.pdf",
  title="23 May 2026",
  text="The fifth edition of the Brazil Europe Air Navigation Performance Comparison Report covers the period from 2019 to 2025. It focuses on the observed performance post COVID, extending the time frame,
and incorporating additional analyses. For example, a more detailed characterisation of
the Brazilian and European network is included.", 
  alt="Comparison of Operational Air Navigation System Performance in Brazil and Europe 2019-2025", 
  command="Resize", 
  options="300x", 
  style="width: 18rem;", 
  class="mb-2"
