...
async function updateNetworkSituationOnPage() {
    ...
    if (latestData) {
        ...
        const starty2dDateString = (month == 0 ? `1` :  `1 January`); // Fixed start of the year
        const endDateString = `${('' + latestDate.getDate()).padStart(2, '0')} ${latestDate.toLocaleString('default', { month: 'long' })} ${year}`;
        const dateString = `${endDateString}`;
        const datey2dRangeString = `${starty2dDateString} - ${endDateString}`;
        
        // Calculate the first day of the rolling week
        const startWeekDate = new Date(latestDate);
        startWeekDate.setDate(latestDate.getDate() - 6);
        const startWeekDateString = `${('' + startWeekDate.getDate()).padStart(2, '0')} ${startWeekDate.toLocaleString('default', { month: 'long' })}`;
        
        // Generate the week range string
...
<div class="col-sm-8"><h3><span>Network status </span> on <span id="day_text_title"></span></h3> 
<div>
...
<iframe id="delay-plot-gauge" class="resp-iframe" src="https://www.eurocontrol.int/Economics/Oscar/plot-pun-nw-gauge.html" frameborder="0" style="border:0;" sandbox="allow-scripts allow-same-origin">
</iframe>
</div>
</div>
<div class="col-sm-8">
<div style="margin-top: 0px; height: 450px;">
<iframe id="delay-plot-evo" class="resp-iframe" src="https://www.eurocontrol.int/Economics/Oscar/plot-pun-nw-evo.html" frameborder="0" style="border:0;" sandbox="allow-scripts allow-same-origin">
</iframe>
</div><!-- closes iframe container -->
</div><!-- closes col -->
</div><!-- closes row in col -->
    ...
    $(document).ready(function () {
        $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
            ...
            iframes.each(function() {
                ...
                setTimeout(function () {
                    iframe.attr('src', src);
                }, 10); // Short delay to allow iframe reload
            });
        });
    });
</script>

<div class="col-sm-4" style="min-height: 475px;"><h3>What's new?</h3><br> 
<div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
<div class="carousel-inner">

::: {#carousel-item .carousel-item .active}
::: {.card .border-0}
[![Published: An intro video to the Performance Review Commission](/images/landing/EUROCONTROL_PRC_VIDEO.PNG)](https://www.youtube.com/watch?v=zLS7bPgazlU){target="_blank"}
...
::: {.card .border-0}
[![Published: PRC Performance Insight #10 - ATM Cost-Effectiveness](/images/landing/2024-06-21_PI10_institutional_framework.png)](https://www.eurocontrol.int/publication/prc-performance-insight-10-atm-cost-effectiveness){target="_blank"}
...
::: {#carousel-item .carousel-item}
::: {.card .border-0}
[![Published: PRC Observer #1 - Can we make aviation green?](/images/landing/PRC_Observer_1.png)](https://www.eurocontrol.int/publication/prc-observer-1-how-can-we-make-aviation-green){target="_blank"}
...
::: {#carousel-item .carousel-item}
::: {.card .border-0}
[![Published: EUROCONTROL Standard Inputs for Economic Analysis (Edition 10.0)](/images/landing/2024-7-15-standard_inputs.png)](https://www.eurocontrol.int/publication/eurocontrol-standard-inputs-economic-analyses){target="_blank"}
...
::: {#carousel-item .carousel-item}
::: {.card .border-0}
[![Published: Data Snapshot #44 - The causes of flight delays ](/images/landing/2024-05-28_DS44_all_causes_delay.png)](https://www.eurocontrol.int/publication/eurocontrol-data-snapshot-44-causes-flight-delays){target="_blank"}
...
<div class="container">
<h3>About the Aviation Intelligence Portal</h3>
