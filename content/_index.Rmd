...
<div class="col-2" ; style="margin: 0px;  ">
  <p class="Scorecard_subt">Vs 2022</p>
...
<div class="carousel-item"><div class="card  border-0"><a href="https://ansperformance.eu/about/prc/" target="_blank"><img class="card-img-top" src="/images/landing/new_prc.png" alt=""><div class="card-body"><h5 class="card-title">Meet the new Performance Review Commission (PRC) members</h5></a><small><p class="card-text">
Learn more about the Performance Review Commission (PRC) and the new members</p></small></div></div></div>

<div class="carousel-item active"><div class="card  border-0"><a href="https://www.eurocontrol.int/publication/eurocontrol-forecast-update-2023-2029-autumn-2023" target="_blank"><img class="card-img-top" src="/images/landing/ectl_fcst.jpg" alt=""><div class="card-body"><h5 class="card-title">EUROCONTROL traffic forecast</h5></a><small><p class="card-text">See the latest update of the 7-year forecast (2023-2029)</p></small></div></div></div>

<div class="carousel-item"><div class="card  border-0"><a href="https://ext.eurocontrol.int/connectivity_web/from" target="_blank"><img class="card-img-top" src="/images/landing/aiu_connex.png" alt=""><div class="card-body"><h5 class="card-title">Are you connected?</h5></a><small><p class="card-text">
Check out our European aviation connectivity dashboard!</p></small></div></div></div>

<div class="carousel-item"><div class="card  border-0"><a href="https://www.eurocontrol.int/news/atm-cost-effectiveness-ace-first-look-ace-2022-data" target="_blank"><img class="card-img-top" src="/images/landing/prc_ace.png" alt=""><div class="card-body"><h5 class="card-title">ATM Cost-effectiveness 2022</h5></a><small><p class="card-text">
Have a first look at the ANSP's 2022 cost-effectiveness data!</p></small></div></div></div>

<div class="carousel-item"><div class="card  border-0"><a href="https://www.eurocontrol.int/publication/eurocontrol-think-paper-21-long-haul-flight-decarbonisation-when-can-cutting-edge" target="_blank"><img class="card-img-top" src="/images/landing/tp21.png" alt=""><div class="card-body"><h5 class="card-title">EUROCONTROL Think Paper #21</h5></a><small><p class="card-text">
Long-haul flight decarbonisation: When can cutting-edge energies & technologies make a difference?</p></small></div></div></div>

<div class="carousel-item"><div class="card  border-0"><a href="/data/"><img class="card-img-top"  src="/images/landing/data_icon.jpg" alt="Data update"><div class="card-body"><h5 class="card-title">Performance data update</h5></a><small><p class="card-text">October 2023 data <br> available for download now</p></small></div></div></div>
...
<div class="card"><a href="/traffic">
  ...
  <div class="card-body"><h6 class="card-title"><i class='fas fa-plane-departure'></i>&nbsp;Traffic</h6></a><small><p class="card-text">[IFR](/acronym/ifr/) flight and [service unit](/acronym/su/) evolution and forecast </p></small>
  </div>
</div>
<div class="card"><a href="/capacity">
  <img class="card-img-top" src="/images/landing/ectl_cap_th.jpg" alt="Capacity">
  <div class="card-body"><h6 class="card-title"><i class='fas fa-clock'></i>&nbsp;Capacity & Delays</h6></a><small><p class="card-text">En-route and airport [ATFM](/acronym/atfm/) delays</p></small>
  </div>
</div>
<div class="card"><a href="/efficiency">
  <img class="card-img-top" src="/images/landing/ectl_env_th.jpg" alt="Efficiency & Environment">
  <div class="card-body"><h6 class="card-title"><i class='fas fa-leaf'></i>&nbsp;Efficiency & Environment</h6></a><small><p class="card-text">Flight efficiency affecting fuel burn and emissions</p></small>
  </div>
</div>
<div class="card"><a href="/economics">
  <img class="card-img-top" src="/images/landing/ectl_cef_th.jpg" alt="Economics">
  <div class="card-body"><h6 class="card-title"><i class='fas fa-euro-sign'></i>&nbsp;Economics</h6></a><small><p class="card-text">Analysis of ANS cost-efficiency</p></small>
  </div>
</div>
</div>
</div>
