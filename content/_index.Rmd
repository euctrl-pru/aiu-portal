...
<a href="https://www.eurocontrol.int/publication/eurocontrol-data-snapshot-56-shifting-weekday-flight-patterns" target="_blank">
<img src="/images/landing/2025-11-17_DS56_weekday_flight_patterns.png" style="border-top-left-radius: 1rem; border-top-right-radius: 1rem; width: 100%;" alt="PRC Observer #4">
</a>
<div style="padding: 1rem;">
<h5><a href="https://www.eurocontrol.int/publication/eurocontrol-data-snapshot-56-shifting-weekday-flight-patterns" target="_blank">Data Snapshot #56 on shifting weekday flight patterns</a></h5>
<small>An analysis of the average number of flights by day of the week reveals that Europe’s air traffic patterns have undergone a notable structural shift over the past two decades: the gap between average daily flights on weekdays and on weekends has narrowed notably over time.</small>
</div>
<div class="card-footer pt-0">
<a href="https://www.eurocontrol.int/publication/eurocontrol-data-snapshot-56-shifting-weekday-flight-patterns" class="card-link" target="_blank">Read more</a> <i class="ml-2 fas fa-arrow-right"></i>
</div>
</div>
</div>
...
<div style="padding: 1rem;">
<h5><a href="https://www.eurocontrol.int/publication/eurocontrol-forecast-update-2025-2031" target="_blank">October 2025 STATFOR Forecast published!</a></h5>
...
<small>The PRC Data Challenge 2025 is still running but the deadline is fast approaching! This year's challenge invites you to build Machine Learning models to predict fuel burn at different stages of flight, using open aviation data. Compete until Nov 30, 2025 and win awards worth 5,000 EUR!</small>
</div>
<div class="card-footer pt-0">
...
<img src="/images/landing/cco_vertical_flight_efficiency.png" style="border-top-left-radius: 1rem; border-top-right-radius: 1rem; width: 100%;" alt="PRC Data Challenge 2025">
</a>
<div style="padding: 1rem;">
<h5><a href="https://ansperformance.eu/efficiency/vfe/" target="_blank">Continuous climb operations (CCO) view added to the Vertical flight efficiency dashboard</a></h5>
...
<small>October 2025 data available for download now!</small>
</div>
<div class="card-footer pt-0">
