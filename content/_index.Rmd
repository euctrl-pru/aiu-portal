...
<div class="carousel-item"><div class="card  border-0"><a href="/data/"><img class="card-img-top"  src="/images/landing/connectivity-update.png" alt="Connectivity update"><div class="card-body"><h5 class="card-title">European Aviation Connectivity Tool has been updated</h5></a><small><p class="card-text">The European Aviation Connectivity Tool has been updated with the inclusion of two additional countries (Norway and Switzerland) and updated geographical regions definitions. Data up to Q3 2023 is now available.</p></small></div></div></div>
