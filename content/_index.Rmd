...
<div class="carousel-item active"><div class="card  border-0"><a href="https://publish.eurocontrol.int/publication/prc-performance-insight-8-atm-performance-benefit-pools-improved-civil-military" target="_blank"><img class="card-img-top" src="/images/landing/pi8.png" alt=""><div class="card-body"><h5 class="card-title">PRC Performance Insight #8</h5></a><small><p class="card-text">
