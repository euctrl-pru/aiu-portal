      ...
      <div id="live" class="tab-pane fade in active show">
        <div class="card border-0 rounded p-3 mb-0 pb-0">
          <iframe id="test_map"
                  ...
                  src="https://www.eurocontrol.int/Economics/Oscar/live_main_statistics_webpage_v11.html"   
                  frameborder="0"
                  scrolling="no"
                  allowfullscreen>
          </iframe>
          <div class="mt-2">
            <p><small><i>The designations and presentation employed on the map do not imply
              the expression of any opinion whatsoever on the part of EUROCONTROL concerning
          ...
          <ul class="nav nav-segment nav-fill align-items-centers mb-4">
            ...
            <li class="nav-item">
              <a class="nav-link"
                data-toggle="tab"
                href="#delay"
                onclick=reloadIframeDelay()>ATFM Delay</a>
            </li>
            <li class="nav-item">
              <a class="nav-link"
                data-toggle="tab"
                href="#punctuality">Punctuality</a>
            </li>
          </ul>
                    ...
                    <div class="col-sm-auto">
                      <ul class="nav nav-segment nav-fill">
                        <li class="">
                          <a class="nav-link active"
                            data-toggle="tab"
                            href=#flights-day>Day</a>
                        </li>
                        <li class="">
                          <a class="nav-link"
                            data-toggle="tab"
                            href="#flights-week">Week</a>
                        </li>
                        <li class="">
                          <a class="nav-link"
                            data-toggle="tab"
                            href="#flights-y2d">Y2D</a>
                        </li>
                      </ul>
                    </div>
                    <!-- End Col -->
                    ...
                    <div class="col-sm-auto">
                      <ul class="nav nav-segment nav-fill">
                        <li class="">
                          <a class="nav-link active"
                            data-toggle="tab"
                            href=#delay-day>Day</a>
                        </li>
                        <li class="">
                          <a class="nav-link"
                            data-toggle="tab"
                            href="#delay-week">Week</a>
                        </li>
                        <li class="">
                          <a class="nav-link"
                            data-toggle="tab"
                            href="#delay-y2d">Y2D</a>
                        </li>
                      </ul>
                    </div>
                  <!-- End Col -->
