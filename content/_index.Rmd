...
<div class="card border-0 rounded">
<a href="https://www.eurocontrol.int/publication/prc-observer-5-data-foundation-credibility" target="_blank">
<img src="/images/landing/2026-02-16_PRC_OBS5.png" style="border-top-left-radius: 1rem; border-top-right-radius: 1rem; width: 100%;" alt="DS57">
</a>
<div style="padding: 1rem;">
<h5><a href="https://www.eurocontrol.int/publication/prc-observer-5-data-foundation-credibility" target="_blank">PRC Observer #5 – Open Data: The Foundation of Credibility</a></h5>
<small>The independent Performance Review Commission (PRC) explains how transparent and widely accepted performance measurement helps build trust and supports stakeholder engagement to improve the performance of the European air transport network..</small>
</div>
<div class="card-footer pt-0">
<a href="https://www.eurocontrol.int/publication/prc-observer-5-data-foundation-credibility" class="card-link" target="_blank">Read more</a> <i class="ml-2 fas fa-arrow-right"></i>
</div>
</div>
</div>
...
<small>This new dashboard shows where you can fly to from a specific European airport and which operators serve those routes. It focuses on direct scheduled airport pairs as a simple and clear indicator of connectivity, and tracks this and other complementary indicators over time. Check out the latest data for January 2026!</small>
</div>
<div class="card-footer pt-0">
