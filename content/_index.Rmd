...
<div class="carousel-item active"><div class="card bg-light border-0"><a href="https://fsr.eui.eu/publications/?handle=1814/75525" target="_blank"><img class="card-img-top" src="/images/landing/prc_tss1.png" alt=""><div class="card-body"><h5 class="card-title">ATM transformation flagships</h5></a><small><p class="card-text">
Read the policy brief from the Florence School of Regulation to learn about the workshop takeaways.</p></small></div></div></div>

<div class="carousel-item"><div class="card bg-light border-0"><a href="https://www.eurocontrol.int/publication/impact-strikes-european-aviation" target="_blank"><img class="card-img-top" src="/images/landing/ectl_strikes.png" alt=""><div class="card-body"><h5 class="card-title">Impact of strikes on aviation</h5></a><small><p class="card-text">Read the new EUROCONTROL paper on the impact of strikes experienced by aviation so far this year.</p></small></div></div></div>
...
<div class="carousel-item"><div class="card  border-0"><a href="/data/"><img class="card-img-top"  src="/images/landing/data_icon.jpg" alt="Data update"><div class="card-body"><h5 class="card-title">Performance data update</h5></a><small><p class="card-text">April 2023 data <br> available for download now</p></small></div></div></div>
