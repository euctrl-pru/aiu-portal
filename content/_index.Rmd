...
<small>This data snapshot analyses the total number of aircraft in the air for any 15-minute interval in 2024. In other words, what was the maximum number of airborne IFR aircraft in the EUROCONTROL area at a given point in time? Let’s have a closer look.</b></small>
</div>
<div class="card-footer pt-0">
...
<small>The Performance Review Commission (PRC) has just released their independent Performance Review Report (PRR) of ANS performance in Europe for 2024.</small>
</div>
<div class="card-footer pt-0">
...
<small>The Leiden University's International Institute of Air and Space Law has published an assessment of the current state of European ATM Transformation based on the critical examination conducted during the third PRC Transformation Support Strategy (TSS) Workshop.</small>
</div>
<div class="card-footer pt-0">
