...
<div class="carousel-item active"><div class="card  border-0"><a href="https://www.eurocontrol.int/publication/air-defender-2023-military-mission-effectiveness-minimal-network-impacts" target="_blank"><img class="card-img-top" src="/images/landing/at2.png" alt=""><div class="card-body"><h5 class="card-title">Air Defender 2023</h5></a><small><p class="card-text">
Read about impact of the Air Defender 2023 exercise on the European ATM network</p></small></div></div></div>
...
<div class="carousel-item"><div class="card  border-0"><a href="https://www.eurocontrol.int/publication/performance-review-report-prr-2022" target="_blank"><img class="card-img-top" src="/images/landing/prr2022.png" alt=""><div class="card-body"><h5 class="card-title">Just published: PRR 2022</h5></a><small><p class="card-text">
...
<div class="carousel-item"><div class="card  border-0"><a href="/data/"><img class="card-img-top"  src="/images/landing/data_icon.jpg" alt="Data update"><div class="card-body"><h5 class="card-title">Performance data update</h5></a><small><p class="card-text">June 2023 data <br> available for download now</p></small></div></div></div>
