...
<div class="carousel-item active"><div class="card  border-0"><a href="https://ext.eurocontrol.int/connectivity_web/from" target="_blank"><img class="card-img-top" src="/images/landing/aiu_connex.png" alt=""><div class="card-body"><h5 class="card-title">Are you connected?</h5></a><small><p class="card-text">
Check out our European aviation connectivity dashboard!</p></small></div></div></div>

<div class="carousel-item"><div class="card  border-0"><a href="https://www.eurocontrol.int/news/latest-monthly-forecasts-indicate-continued-growth-over-next-six-months" target="_blank"><img class="card-img-top" src="/images/landing/air_fcst.png" alt=""><div class="card-body"><h5 class="card-title">EUROCONTROL traffic forecast</h5></a><small><p class="card-text">Latest forecasts indicate continued growth over the next 6 months</p></small></div></div></div>
...
<div class="carousel-item"><div class="card  border-0"><a href="/data/"><img class="card-img-top"  src="/images/landing/data_icon.jpg" alt="Data update"><div class="card-body"><h5 class="card-title">Performance data update</h5></a><small><p class="card-text">September 2023 data <br> available for download now</p></small></div></div></div>
