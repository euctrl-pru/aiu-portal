...
<div class="carousel-item active"><div class="card  border-0"><a href="https://www.eurocontrol.int/publication/performance-review-report-prr-2022" target="_blank"><img class="card-img-top" src="/images/landing/prr2022.png" alt=""><div class="card-body"><h5 class="card-title">Just published: PRR 2022</h5></a><small><p class="card-text">
Read the Performance Review Commission's final report on European ATM performance in 2022</p></small></div></div></div>

<div class="carousel-item"><div class="card bg-light border-0"><a href="https://www.eurocontrol.int/publication/air-traffic-management-cost-effectiveness-ace-benchmarking-report-2023-edition" target="_blank"><img class="card-img-top" src="/images/landing/ace_23.png" alt=""><div class="card-body"><h5 class="card-title">ACE benchmarking report</h5></a><small><p class="card-text">Read our latest ATM Cost-Effectiveness Benchmarking Report (Edition 2023)</p></small></div></div></div>

<div class="carousel-item"><div class="card bg-light border-0"><a href="/traffic/statfor/"><img class="card-img-top" src="/images/landing/fcst.png" alt=""><div class="card-body"><h5 class="card-title">Interactive forecast chart</h5></a><small><p class="card-text">
Check out our new interactive chart showing the latest 7-year forecast for all traffic zones</p></small></div></div></div>

<div class="carousel-item"><div class="card bg-light border-0"><a href="/publications/prc/news/2023_05_16_prc_news/"><img class="card-img-top" src="/images/landing/prc_tss1.png" alt=""><div class="card-body"><h5 class="card-title">ATM transformation flagships</h5></a><small><p class="card-text">
Read the policy brief from the Florence School of Regulation to learn about the workshop takeaways.</p></small></div></div></div>

<div class="carousel-item"><div class="card  border-0"><a href="/data/"><img class="card-img-top"  src="/images/landing/data_icon.jpg" alt="Data update"><div class="card-body"><h5 class="card-title">Performance data update</h5></a><small><p class="card-text">May 2023 data <br> available for download now</p></small></div></div></div>
