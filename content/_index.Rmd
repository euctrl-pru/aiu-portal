...
<div class="carousel-item active"><div class="card bg-light border-0"><a href="/publications/prc/news/2023_05_16_prc_news/"><img class="card-img-top" src="/images/landing/prc_tss1.png" alt=""><div class="card-body"><h5 class="card-title">ATM transformation flagships</h5></a><small><p class="card-text">
