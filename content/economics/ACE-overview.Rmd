...
In addition to the publication of interim and final annual reports, an interactive dashboard containing the whole ACE data (2002-2022) has been developed. It enables the aviation community to build customised views on ANSPs economic performance. 
</div><!-- closes col  -->
...
<div class="container">
#### Latest ACE benchmarking report (May 2024 edition)
This report is based on the 2022 data submitted by ANSPs in July 2023, and thoroughly reviewed by the PRU. It analyses ANSPs’ performance in a context marked by the traffic recovery following the shock caused by the COVID-19 pandemic. 
...
*	Traffic (measured in composite flight-hours) rose by +58.3% in 2022 but remained -13.3% lower than in 2019. At ANSP level, a wide range of recovery rates is observed (from -51% to +14%). The war in Ukraine resulted in airspace closures and bans on air carriers which impacted traffic flows in Europe.
...
*	After two years of consecutive decreases, total ATM/CNS provision costs rose by +3.4% (+€295.8M) in 2022, reflecting cost increases for 26 out of 38 ANSPs.

*	In 2022, the number of ATM/CNS staff was slightly lower than in 2021 (-0.9% or -470 FTEs), mainly because of support staff reductions. The number of ATCOs in OPS increased by +2.1% (+348 FTEs).
...
A new analysis on the regulatory, institutional, and corporate governance aspects shows interesting findings when considering different regulation regimes and legal statuses. Although interactions are complex and no straightforward relationships emerged at individual ANSP level, these factors can create incentives or constraints, which may affect ANSP performance.
...
<div class="row align-items-start">
<div class="col-md-6">
#### Latest ACE Report (May 2024 edition)

<div class="row align-items-start">
<div class="col-sm-2">
  <img src="/images/prc/ace2024ed.png" alt="ACE 2024 Edition" style="border: 1px solid rgba(0,0,0,.125)">
...
<a href="/library/ace/eurocontrol-ace-benchmarking-report-2024-edition.pdf" data-toggle="tooltip" title="Download pdf version" download><i class="fas fa-download"></i></a>
...
<summary>**Main Chapters:**</summary>
  ...
  4. Forward-looking cost-effectiveness (2023-2027)
  5. Financial indicators calculated from ANSPs financial statements
  6. Regulatory, institutional and corporate governance arrangements
</details>

<details>
<summary>**Annexes**</summary>
  * ANNEX 1 – Status of ANSPs 2022 Annual Reports
...
Access information on individual ANSPs cost-effectiveness performance (2017-2022), comparison with peers and historical information on capital investments projects.
</div>
</div> <!-- closes secondary row -->
...
<div class="card" ><a href="https://www.eurocontrol.int/publication/atm-cost-effectiveness-ace-first-look-ansps-2023-data" target="_blank">
  <img class="card-img-top" src="/images/eco/first-look2023.png" alt="First look at 2023 ACE data">
  <div class="card-body"><h5 class="card-title">First look at ANSPs’ 2023 data</h5></a><p class="card-text"></p>
  </div>
</div>
