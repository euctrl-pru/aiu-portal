...
<div class="container">
#### [High-level summary report on preliminary ACE 2024 data (December 2025)](https://ansperformance.eu/economics/ace/ace-hlsr/)
This [report](https://ansperformance.eu/economics/ace/ace-hlsr/) is based on the 2024 data submitted by ANSPs in July 2025. It should be noted that the data presented in this document are still preliminary and not yet fully validated. The final ACE benchmarking report will provide more detailed information on observed changes for selected performance indicators both at pan-European system level and at ANSP level.
