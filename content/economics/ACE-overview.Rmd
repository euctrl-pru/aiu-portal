...
*	In 2023, the number of ATM/CNS staff was slightly higher than in 2022 (+1% or +537 FTEs), mainly because of increases in the number of ATCOs in OPS (+231 FTEs), OPS support staff (+122FTEs) and technical support staff for operational maintenance (+112 FTEs).
...
<div class="card" ><a href="https://ansperformance.eu/economics/ace/ace-hlsr/" target="_blank">
  <img class="card-img-top" src="/images/eco/ace-hlsr2023.png" alt="High Level Summary Report 2023 Data">
  <div class="card-body"><h5 class="card-title">High Level Summary Report on Preliminary ACE 2023 Data</h5></a><p class="card-text"></p>
  </div>
</div>
