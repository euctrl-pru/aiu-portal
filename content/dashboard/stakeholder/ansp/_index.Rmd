...
blogdown::shortcode(
  "bootstrap-card-alt",
  img = "2026-05-12_ansp_db.png",
  link = "/dashboard/stakeholder/ansp/ansp_db",
  title = "ANSP Operational Performance Dashboard",
  text = "Daily overview of operational ANSP performance across a wide spectrum of indicators.<br><br> <div class='badge-container'><span class='badge badge-secondary'>General Performance</span></div>",
