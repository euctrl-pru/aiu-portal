...
The figure below presents the EUROCONTROL 7-year forecast (2023-2029) for air traffic movements (IFR) in millions of flights (Edition Autumn 2023). The information is available by [traffic zone (TZ)](https://ansperformance.eu/definition/traffic-zone/) and includes actual traffic up to 2022 and different forecast scenarios (high, base, low) up to 2029. Simply select the TZ you are interested in from the drop-down menu to see the detailed information for each year.
...
data <- read_csv2(here("content", "traffic", "eurocontrol-forecast-2023-2029-traffic-table-october2023-unrounded.csv"))
