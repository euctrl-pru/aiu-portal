...
data <- read_csv(here("content", "traffic", "eurocontrol-forecast-2024-2030-traffic-table-october2024-unrounded.csv"))
...
For more information about the forecasts and the associated data, see the [EUROCONTROL Forecast Update 2024-2030 publication](https://www.eurocontrol.int/publication/eurocontrol-forecast-2024-2030-autumn-update).
