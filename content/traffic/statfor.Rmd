...
The figure below presents the EUROCONTROL 7-year forecast (2026-2032) for air traffic movements (IFR) in millions of flights. This Seven-Year Forecast (Spring 2026) builds on the October 2025 forecast and incorporates the latest observed flight trends and route patterns up to early 2026, together with a comprehensive update of all forecast inputs, including as much as possible recent geopolitical developments in the Middle East/Gulf region. The information is available by [traffic zone (TZ)](https://ansperformance.eu/definition/traffic-zone/) and includes actual traffic up to 2025 and different forecast scenarios (high, base, low) up to 2032. Simply select the TZ you are interested in from the drop-down menu to see the detailed information for each year.
  ...
  buttons = lapply(1:length(tz_values), function(i) {
    list(method = "update",
         args = list(
           ...
           list(title = list(
             text = paste0("<b>EUROCONTROL 7-year forecast for ", tz_values[i], " 2026-2032 </b> <br><span style='font-size:0.8em;color:grey'>Actual and future IFR movements</span>")
           ))
         ),
         label = tz_values[i])
  })
...
plot <-
  plot %>% layout(
    title = list(
      text = paste0("<b>EUROCONTROL 7-year forecast for ", tz_values[1], " 2026-2032 </b> <br><span style='font-size:0.8em;color:grey'>Actual and future IFR movements</span>")
    ),
    xaxis = list(
      title = "",
      tick0 = 2019,
...
For more information about the forecasts and the associated data, see the [EUROCONTROL Forecast Update 2026-2032 publication](https://www.eurocontrol.int/publication/eurocontrol-forecast-update-2026-2032).
