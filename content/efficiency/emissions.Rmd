...
co2_nw_plot3 <- co2_data_plot_nw_ld %>%
  ...
  layout(
    shapes = list(
      vline(as.Date('2026-01-01')),
      vline(as.Date('2024-01-01')) ,vline(as.Date('2025-01-01')),
      vline(as.Date('2023-01-01')) ,vline(as.Date('2022-01-01')),
                  vline(as.Date('2021-01-01')),vline(as.Date('2020-01-01'))),
    annotations = list(a1, a2, a3, a4, a5, a6, a7, a8),
     autosize = T,
