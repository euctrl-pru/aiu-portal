...
description: "An overview of the horizontal en-route flight efficiency for the entire
  EUROCONTROL area and per individual state."
---
...
.resp-container {
    position: relative;
    overflow: hidden;
    padding-top: 120.0%; #including 4 last countries in the table
}
...
<iframe class="resp-iframe" src="https://app.powerbi.com/view?r=eyJrIjoiMTczODk5NTctYWJhOC00ZGM4LThlMzItYjcwNDZmM2Q1MGJkIiwidCI6Ijc2ZjMzYzIwLTU5NzktNDQwOC1hZGY3LThiM2M0YmU5NWU1MiIsImMiOjl9" frameborder="0" style="border:0" allowfullscreen></iframe>
</div>