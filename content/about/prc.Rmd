...
<div class="card">
 <a href="/about/prc_XF"><img class="card-img-top" src="/images/prc/prc_XF.jpg" alt="Xavier FRON">
  <div class="card-body"><h5 class="card-title">Xavier FRON</h5></a><p class="card-text" style="color:grey">Focus: Economics</p>
  </div></div>
-->
...
<div class="card">
  ...
  <div class="card-body"><h5 class="card-title">Ismail Hakki POLAT</h5></a><p class="card-text" style="color:grey">Focus: Airports</p>
</div></div>
...
<div class="card-deck">
 ...
 <a href="/about/prc_MS"><div class="card">
  ...
  <div class="card-body"><h5 class="card-title">Daniel WEDER </h5></a><p class="card-text" style="color:grey">Focus: ATC/OPS</p>
  </div></div>
