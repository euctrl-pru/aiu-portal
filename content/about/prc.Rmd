...
<div class="card">
  <img class="card-img-top" src="" alt="Xavier FRON">
  <div class="card-body"><h5 class="card-title">Xavier FRON</h5><p class="card-text" style="color:grey">Focus: Economics</p>
  </div></div>
<div class="card">
  <img class="card-img-top" src="" alt="Piotr IKANOWICZ">
  <div class="card-body"><h5 class="card-title">Piotr IKANOWICZ</h5><p class="card-text" style="color:grey">Focus: Airlines</p>
  </div></div>
<div class="card">
<<<<<<< HEAD
  <img class="card-img-top" src="/images/person_image_placeholder.png" alt="José Miguel de PABLO GUERRERO">
=======
  <img class="card-img-top" src="" alt="José Miguel de PABLO GUERRERO">
>>>>>>> origin/202308-release
...
<div class="card-deck">
 ...
 <div class="card">
  <img class="card-img-top" src="" alt="Michael STEINFURTH">
...
<div class="card">
  ...
  <div class="card-body"><h5 class="card-title">Dr Peter WHYSALL </h5><p class="card-text">Acting PRC Chairman</p><p class="card-text" style="color:grey">Focus: Environment</p>
  </div></div> 
<div class="card">
