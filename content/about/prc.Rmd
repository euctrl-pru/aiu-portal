...
<div class="card">
 <img class="card-img-top" src="/images/prc/prc_XF.jpg" alt="Xavier FRON">
  <div class="card-body"><h5 class="card-title">Xavier FRON</h5><p class="card-text" style="color:grey">Focus: Economics</p>
  </div></div>

<div class="card">
 <img class="card-img-top" src="/images/prc/prc_PI.jpg" alt="Dr Piotr IKANOWICZ">
  <div class="card-body"><h5 class="card-title">Piotr IKANOWICZ</h5><p class="card-text">PRC Vice Chairman</p><p class="card-text" style="color:grey">Focus: Airlines</p>
  </div></div>

<div class="card">
  <img class="card-img-top" src="/images/prc/prc_JM.jpg" alt="José Miguel de PABLO GUERRERO">
  <div class="card-body"><h5 class="card-title">José Miguel de PABLO GUERRERO</h5><p class="card-text" style="color:grey">Focus: ANSP/Management</p>
  </div></div> 
<div class="card">
...
<div class="card-deck">
 ...
 <div class="card">
  ...
  <div class="card-body"><h5 class="card-title">Michael STEINFURTH</h5><p class="card-text" style="color:grey">Focus: Safety / Civil-Military Coordination</p>
  </div></div> 
  <div class="card">
...
<div class="card">
  <img class="card-img-top" src="/images/prc/prc_PW.jpg" alt="Dr Peter WHYSALL ">
  <div class="card-body"><h5 class="card-title">Dr Peter WHYSALL </h5><p class="card-text">PRC Chairman</p><p class="card-text" style="color:grey">Focus: Environment</p>
  </div></div> 
<div class="card">
