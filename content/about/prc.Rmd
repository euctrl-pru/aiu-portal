...
<div class="card">
  <a href="/about/prc_IP"><img class="card-img-top" src="/images/prc/prc_IP.JPG" alt="Ismail Hakki POLAT ">
  <div class="card-body"><h5 class="card-title">Ismail Hakki POLAT</h5></a><p class="card-text" style="color:grey">Focus: Airports</p><br>
</div></div>
...
<div class="card-deck">
 ...
 <a href="/about/prc_MS"><div class="card">
  <img class="card-img-top" src="/images/prc/prc_MS.jpg" alt="Michael STEINFURTH">
  <div class="card-body"><h5 class="card-title">Michael STEINFURTH <br> † Jan. 2025</h5></a>
  <p class="card-text" style="color:grey">Focus: Safety / Civil-Military Coordination</p>
  </div></div> 

  <div class="card">
  <a href="/about/prc_DW"><img class="card-img-top" src="/images/prc/prc_DW.jpg" alt="Daniel WEDER ">
  <div class="card-body"><h5 class="card-title">Daniel WEDER </h5></a><p class="card-text" style="color:grey">Focus: ATC/OPS</p><br>
  </div></div>

<div class="card">
  <a href="/about/prc_PW"><img class="card-img-top" src="/images/prc/prc_PW.jpg" alt="Dr Peter WHYSALL ">
  <div class="card-body"><h5 class="card-title">Dr Peter WHYSALL </h5></a><p class="card-text">PRC Chairman</p><p class="card-text" style="color:grey">Focus: Environment</p>
  </div></div>
