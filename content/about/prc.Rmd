...
description: Learn more about the Performance Review Commission background, tasks and deliverables.
permalink: /about/prc/
---
...
<!--
<div class="card">
 <a href="/about/prc_XF"><img class="card-img-top" src="/images/prc/prc_XF.jpg" alt="Xavier FRON">
  <div class="card-body"><h5 class="card-title">Xavier FRON</h5></a><p class="card-text" style="color:grey">Focus: Economics</p><br>
  <p class="card-text" style="color:grey">Focus: Economics</p>
  [Undertaking of independence](/about/prc/#undertaking-of-independence-declaration-of-potential-interest-1)
  </div></div>
-->

<div class="card">
 <a href="/about/prc_XF"><img class="card-img-top" src="/images/prc/prc_XF_2025.jpg" alt="Xavier FRON">
  <div class="card-body"><h5 class="card-title">Xavier FRON</h5></a><p class="card-text" style="color:grey">Focus: Economics</p><br>
  </div></div>

<div class="card">
 <a href="/about/prc_PI"><img class="card-img-top" src="/images/prc/prc_PI_2025.jpg" alt="Dr Piotr IKANOWICZ">
  <div class="card-body"><h5 class="card-title">Dr Piotr IKANOWICZ</h5></a><p class="card-text">PRC Vice Chairman</p><p class="card-text" style="color:grey">Focus: Airlines</p>
  </div></div>

<div class="card">
  <a href="/about/prc_JPG"><img class="card-img-top" src="/images/prc/prc_JM_2025.jpg" alt="José Miguel de PABLO GUERRERO">
  <div class="card-body"><h5 class="card-title">José Miguel de PABLO GUERRERO</h5></a><p class="card-text" style="color:grey">Focus: ANSP/Management</p>
  </div></div> 

<div class="card">
  <a href="/about/prc_JP"><img class="card-img-top" src="/images/prc/prc_JP_2025.JPG" alt="Jörg PIKOLIN ">
  <div class="card-body"><h5 class="card-title">Jörg PIKOLIN </h5></a><p class="card-text" style="color:grey">Focus: Environment/ ATC OPS</p><br>
</div></div>
...
<div class="card-deck">
 ...
 <a href="/about/prc_FLG"><div class="card">
  <img class="card-img-top" src="/images/prc/prc_FLG_2025.jpg" alt="Franck Le GALL ">
  <div class="card-body"><h5 class="card-title">Franck Le GALL</h5></a>
  <p class="card-text" style="color:grey">Focus: Airports</p>
  </div></div> 

  <div class="card">
  <a href="/about/prc_KM"><img class="card-img-top" src="/images/prc/prc_KM_2025.jpg" alt="Dr. Klaus MEIER ">
  <div class="card-body"><h5 class="card-title">Dr Klaus MEIER </h5></a><p class="card-text" style="color:grey">Focus: ATC/OPS</p><br>
  </div></div>

<div class="card">
  <a href="/about/prc_CL"><img class="card-img-top" src="/images/prc/prc_CL_2025.jpg" alt="Claudio LUCCIOLI ">
  <div class="card-body"><h5 class="card-title">Claudio LUCCIOLI </h5></a><p class="card-text">PRC Chairman</p><p class="card-text" style="color:grey">Focus: Safety / Civil-Military Coordination</p>
  </div></div>
...
<a href="/library/prc/2023_2025_PRC_UoI_DoI.pdf" download>Undertaking of independence / Declaration of potential interest</a>
