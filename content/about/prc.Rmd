...
<div class="card">
 <a href="/about/prc_PI"><img class="card-img-top" src="/images/prc/prc_PI.jpg" alt="Dr Piotr IKANOWICZ">
  <div class="card-body"><h5 class="card-title">Piotr IKANOWICZ</h5></a><p class="card-text">PRC Vice Chairman</p><p class="card-text" style="color:grey">Focus: Airlines</p>
  </div></div>
